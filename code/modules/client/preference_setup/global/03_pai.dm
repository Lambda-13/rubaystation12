...
/datum/category_item/player_setup_item/player_global/pai/content(var/mob/user)
	...
	. += "Внеигровое описание: <a href='?src=\ref[src];option=ooc'>[candidate.comments ? TextPreview(candidate.comments, 40) : "None Set"]</a><br>"
	. += "<div>Тип пИИ: <a href='?src=\ref[src];option=chassis'>[candidate.chassis]</a><br>"
	. += "<div>Тип голоса: <a href='?src=\ref[src];option=say'>[candidate.say_verb]</a><br>"
